...
module.exports = function (app, limiters) {
   ...
   */
  app.get(link("books.list"), limiters.One_sec, getBooks);
   ...
   */
  app.get(link("books.read", { id: ":id" }), limiters.Five_sec, getBook);
